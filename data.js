...
/* ------------------------------------------------------------
   ...
   ------------------------------------------------------------ */
const NEWS_LIST = [
  { date:"2026/06/06", cat:"site", text:"ORANGEHUBセクションを廃止し、\nExplore　見る・知る・楽しむ　を新設" },
  { date:"2026/06/04", cat:"content", text:"大会結果、フォトギャラリーセクション\nBGM再生時にアニメーションを追加" },
  { date:"2026/06/04", cat:"club", text:"ラージボール体験のお知らせをバナーに表記" },
  { date:"2026/06/02", cat:"content", text:"訪問者数カウンタをBGM再生と共用\n明滅・脈動表示させ強調" },
  { date:"2026/06/02", cat:"gallery", text:"BGM再生ボタンを追加" },
  { date:"2026/06/02", cat:"content", text:"大会結果ページにBGMを追加" },
  { date:"2026/05/30", cat:"club", text:"大会・試合結果に速報を更新" },
...
let photos = [
  {
    "id": 1,
    "src": "https://drive.google.com/thumbnail?id=1EkorxytBzaQ9V4H3Tf6qi7gLOAouesy0&sz=w800",
    "category": "atmosphere",
    "caption": ""
  },
  {
    "id": 2,
    "src": "https://drive.google.com/thumbnail?id=1zq8taEWxXqu5Srk01T0e-Dl9UGIMmWA8&sz=w800",
    "category": "atmosphere",
    "caption": ""
  },
  {
  ...
  {
    "id": 6,
    "src": "https://drive.google.com/thumbnail?id=1ZXsm4gt8A2tt3wKTyJnD5DmGz_6w0DU0&sz=w800",
    "category": "equipment",
    "caption": ""
  },
  {
